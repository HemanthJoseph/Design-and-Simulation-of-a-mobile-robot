...
if __name__=="__main__":
    ...
    pub_right = rospy.Publisher('/trolley/FR_axel_controller/command', Float64, queue_size=10) # Add your topic here between ''. Eg '/my_robot/steering_controller/command'
    pub_left = rospy.Publisher('/trolley/FL_axel_controller/command', Float64, queue_size=10) 
    pub_move_RR = rospy.Publisher('/trolley/RR_wheel_controller/command', Float64, queue_size=10) # Add your topic for move here '' Eg '/my_robot/longitudinal_controller/command'
